...
/**
 * 
	* @ClassName: FilterPostiveReadFileBZ2 
	* @Description:提取源数据中带有积极情感表情的帖子，输入:positive.txt;输出：  positive_emoticon.csv
	* @author zeze
	* @date 2016年3月8日 上午10:18:29 
	*
 */
public class FilterPostiveReadFileCsv {
	public static void main(String[] args) {
		BufferedReader br=null;
		FileReader reader1=null;
		String srcdir="I:\\毕业设计\\数据集\\";
		File file = null;
		...
		for (int i = 11; i <= 11; i++) {
			...
			for (File f1 : files1) {
				if (f1.getName().endsWith(".csv")) {
					...
					// 读取
					try {
						fw = new FileWriter(new File(dir2 + "positive_emoticon" + ".csv"), true);
